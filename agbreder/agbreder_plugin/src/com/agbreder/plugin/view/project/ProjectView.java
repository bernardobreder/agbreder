package com.agbreder.plugin.view.project;
...
import com.agbreder.plugin.element.project.BRootBinary;
...
public class ProjectView extends ViewPart {
	...
	private static final ProjectView instance = new ProjectView();

	public static final String ID = "agbreder_plugin.view.project.ProjectView";
	...
	private void makeActions() {
		action1 = new Action() {
			public void run() {
				Object object = BActivator.getDefault().getBundle().getEntry("/icons/");
