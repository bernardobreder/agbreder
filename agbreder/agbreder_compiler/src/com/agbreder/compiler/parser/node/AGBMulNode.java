 ...
 */
public class AGBMulNode extends AGBBinaryNode {
	 ...
	 * @param parent
	 */
	public AGBMulNode(AGBNode parent) {
		super(parent);
	}
	...
	public void link(AGBCompileContext context) throws AGBException {
		...
		if (!this.getLeft().getType().isNumber()) {
			throw new AGBTokenException("multiply operator work with number types", this.getLeft().getToken());
		}
