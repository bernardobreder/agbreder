 ...
 */
public class AGBModNode extends AGBBinaryNode {
	 ...
	 * @param parent
	 */
	public AGBModNode(AGBNode parent) {
		super(parent);
	}
	...
	public void link(AGBCompileContext context) throws AGBException {
		...
		if (!this.getLeft().getType().isNumber()) {
			throw new AGBTokenException("mod operator work with number types", this.getLeft().getToken());
		}
