 ...
 */
public class AGBDivNode extends AGBBinaryNode {
	 ...
	 * @param parent
	 */
	public AGBDivNode(AGBNode parent) {
		super(parent);
	}
	...
	public void link(AGBCompileContext context) throws AGBException {
		...
		if (!this.getLeft().getType().isNumber()) {
			throw new AGBTokenException("divide operator work with number types", this.getLeft().getToken());
		}
