 ...
 */
public class AGBBooleanTypeNode extends AGBTypeNode {

	/** Instancia Unica */
	private static final AGBBooleanTypeNode instance = new AGBBooleanTypeNode();
	 ...
	 * @param token
	 */
	public AGBBooleanTypeNode(AGBToken token) {
		super(token);
	}
	 ...
	 * @return the instance
	 */
	public static AGBBooleanTypeNode getInstance() {
		return instance;
	}
