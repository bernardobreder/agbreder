 ...
 */
public class AGBOrNode extends AGBBinaryNode {
	 ...
	 * @param parent
	 */
	public AGBOrNode(AGBNode parent) {
		super(parent);
	}
	...
	public void link(AGBCompileContext context) throws AGBException {
		...
		if (!this.getLeft().getType().isBoolean()) {
			throw new AGBTokenException("or operator work with boolean types", this.getLeft().getToken());
		}
	...
	public void build(OpcodeOutputStream output) throws IOException, AGBException {
		...
		output.opJumpTrueDup(this.index);
