...
/**
 * Realiza uma requisição de conexão
 * 
 * @author bernardobreder
 */
public class AGBConnectRequest extends AGBRequest {
	 ...
	 * @param rootElem
	 */
	public AGBConnectRequest(Element rootElem) {
	 ...
	 * @param page
	 */
	public AGBConnectRequest(String project, String page) {
		super();
